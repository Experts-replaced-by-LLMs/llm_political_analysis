...
def analyze_text_with_batch(prompt_list, model, parse_retries=3, max_retries=3, concurrency=5):
    """
...
def bulk_analyze_text(file_list, model_list, issue_list, results_file):
    """
    ...
    - summary_model (str): The name or ID of the OpenAI model to use for summarization. Defaults to "claude-3-5-sonnet-20240620".
    ...
    for file in file_list:
        ...
        for issue in issue_list:
            ...
            for model in model_list:
                ...
                results = analyze_text_with_batch(prompts, model, parse_retries=3)
