...
def bulk_analyze_text(file_list, model_list, issue_list, probabilities=False, summary_model="gpt-4o"):
    """
    ...
    final_df = final_df[['file', 'issue', 'model', 'score', 'error_message', 'prompt']]
    return final_df